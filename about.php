...
<div class="container hero-about">
    ...
    <div class="row">
        ...
        <div class="additional-info yellow background">
            <span class="title">
                Хочешь приобрести знания и поступить в престижный вуз?!
            </span>
            <p class="description">
                Команда «IQ-Центр» поможет тебе освоить школьные предметы и подготовиться к поступлению! Современные методики, опытные репетиторы, качественная подготовка – залог отличных оценок, успешной сдачи экзаменов и ЦТ!
            </p>
        ...
        <div class="logo-block yellow background">
            <div class="wrapper">
                ...
                <span class="title">Приглашаем тебя пополнить ряды учащихся</span>
                <br>
                <span class="description">
                     и пройти курсы подготовки в репетиторском «IQ-центре» в Минске!
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="text-wrapper eight columns offset-by-two">
            <div class="one-third column">
                <b>Обучение проводится в мини-группах.</b> <br>
            ...
            <div class="one-third column">
                <b>Обучение в мини-группах является
                    антикризисным предложением: </b> <br>
                Позволяет существенно сэкономить деньги, но в тоже время получить высокий результат!
            </div>
            <div class="one-third column">
                <b>Успешные показатели работы центра</b> <br> позволяют нам увеличивать количество желающих пройти обучение и подготовки к экзаменам.
