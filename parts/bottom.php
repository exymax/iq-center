    ...
    <div class="row">
        <div class="two columns offset-by-one">
            <ul class="links">
                ...
                <li><a href="teachers.php">Вакансии</a></li>
            </ul>
        </div>
        <div class="two columns">
            <ul class="links">
                <li class="title">УСЛУГИ</li>
                <li><a href="service.php">Подготовка к ЦТ</a></li>
                <li><a href="service.php">Школьный курс</a></li>
                <li><a href="service.php">Подготовка к гимназии</a></li>
                <li><a href="service.php">Подготовка к школе</a></li>
            </ul>
        </div>
        <div class="two columns">
            <ul class="links">
                <li class="title">ВЫБОР ПРОФЕССИИ</li>
                <li><a href="profession.php">Авторская методика Елены Каверович</a></li>
                <li><a href="profession.php">Психологические консультации</a></li>
            </ul>
        </div>
        <div class="two columns">
            <ul class="links">
                ...
                <li><a href="pricing.php">Способы</a></li>
            </ul>
        </div>
        <div class="two columns">
            <ul class="links">
