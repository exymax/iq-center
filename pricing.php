...
<div class="container hero-pricing">
    <div class="fader"></div>
    <div class="row">
        <div class="header u-full-width">
            ...
            <ul class="u-pull-right navigation">
                ...
                <li class="active"><a href="pricing.php">Стоимость</a></li>
        ...
        <div class="info eight columns offset-by-two">
            ...
            <div class="mail-container ten columns offset-by-one">
                <h4 class="title">ЗАПОЛНИТЕ ФОРМУ ДЛЯ СВЯЗИ</h4>
